    	...
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    <!-- Main menu -->
					<li ><a href="projlist.php"><i class="glyphicon glyphicon-home"></i> 主页</a></li>
					<!--<li><a href="calendar.php"><i class="glyphicon glyphicon-calendar"></i> 待办事件</a></li> -->
					<li class="current"><a href="stats.php"><i class="glyphicon glyphicon-stats"></i> 数据统计</a></li>
					<li ><a href="uploaddata.php"><i class="glyphicon glyphicon-tasks"></i> 上传数据</a></li>
